		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[D15] Mentoring 02",
									"targetURL": "#mentoringd1502mentoringd1502-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mentoringd1502mentoringd1502-display": {
								"semanticObject": "mentoringd1502mentoringd1502",
								"action": "display",
								"description": "[D15] Mentoring 02",
								"title": "[D15] Mentoring 02",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mentoringd1502.mentoringd1502",
									"url": sap.ui.require.toUrl("mentoringd1502/mentoringd1502")
								}
							}
						}
					}
